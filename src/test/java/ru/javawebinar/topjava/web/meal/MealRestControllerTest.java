...
import static ru.javawebinar.topjava.MealTestData.createInvalid;
...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void createWithDuplicatedDateTime() throws Exception {
        Meal newMeal = new Meal(null, of(2020, Month.JANUARY, 30, 10, 0), "description", 1000);
        MvcResult result = perform(MockMvcRequestBuilders.post(REST_URL)
                ...
                .andReturn();
        TestUtil.assertErrorMessage(result, messageSource, "meal.duplicate");
    }
